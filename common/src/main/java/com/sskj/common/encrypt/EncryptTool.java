...
public class EncryptTool {
    ...
    public static String encryptAES(String data, String key) {
        try {
            return new String(EncodeTool.base64Encode(encryptAES(data.getBytes("UTF-8"), key.getBytes("UTF-8"))), "UTF-8");
    ...
    public static String decryptAES(String data, String key) {
        try {
            byte[] r = decryptAES(EncodeTool.base64Decode(data.getBytes()), key.getBytes("UTF-8"));
            return new String(getRealByte(r), "UTF-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return null;
