...
public class VerifyPasswordDialog_ViewBinding implements Unbinder {
  ...
  public VerifyPasswordDialog_ViewBinding(VerifyPasswordDialog target, View source) {
    ...
    target.emailLayout = Utils.findRequiredViewAsType(source, R.id.email_layout, "field 'emailLayout'", LinearLayout.class);
    target.emailCodeEdt = Utils.findRequiredViewAsType(source, R.id.email_code_edt, "field 'emailCodeEdt'", EditText.class);
    target.getEmailCodeTv = Utils.findRequiredViewAsType(source, R.id.get_email_code_tv, "field 'getEmailCodeTv'", TextView.class);
  ...
  public void unbind() {
    ...
    target.emailCodeEdt = null;
    target.getEmailCodeTv = null;
