...
public class NoTopCornerTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private int mBarStrokeColorRes;
    ...
    private float[] normalRadiusArr = new float[8];

    public NoTopCornerTabLayout(Context context) {
        this(context, null, 0);
    }

    public NoTopCornerTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NoTopCornerTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mDividerColorRes = ta.getResourceId(R.styleable.SegmentTabLayout_tl_divider_color, mIndicatorColor);
        ...
        mBarStrokeColorRes = ta.getResourceId(R.styleable.SegmentTabLayout_tl_bar_stroke_color, mIndicatorColor);
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        normalRadiusArr[2] = 0;
        normalRadiusArr[3] = 0;
        normalRadiusArr[4] = mIndicatorCornerRadius;
        normalRadiusArr[5] = mIndicatorCornerRadius;
        normalRadiusArr[6] = mIndicatorCornerRadius;
        normalRadiusArr[7] = mIndicatorCornerRadius;
        //draw rect
        mRectDrawable.setColor(mBarColor);
        mRectDrawable.setStroke((int) mBarStrokeWidth, mBarStrokeColor);
        mRectDrawable.setCornerRadii(normalRadiusArr);
