...
public class EntrustOrder {
    ...
    public Object getMoney_six() {
        return money_six;
    }

    public void setMoney_six(String money_six) {
