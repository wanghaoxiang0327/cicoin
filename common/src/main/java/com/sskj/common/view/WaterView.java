...
public class WaterView extends FrameLayout {
    ...
    private static final List<Float> Y_MAX_CHOSE_RANDOMS = Arrays.asList(
            0.06f, 0.12f, 0.18f, 0.24f, 0.30f, 0.36f, 0.42f, 0.48f, 0.54f);
    /**
     * x坐标当前可选的随机数组
     */
    ...
    //子view的资源文件
    private int mChildViewRes = R.layout.common_water_item;

    private LayoutInflater mInflater;
    private boolean isOpenAnimation;//是否开启动画
    ...
    private List<WaterBean> mWaters;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            //根据isCancelAnimation来标识是否退出，防止界面销毁时，再一次改变UI
     ...
     * @param waters
     */
    public void setWaters(final List<WaterBean> waters) {
     ...
     * @param waters
     */
    private void setDatas(List<WaterBean> waters) {
        reset();
    ...
    private void handViewClick(View view) {
        ...
        if (tag instanceof WaterBean) {
            WaterBean waterTag = (WaterBean) tag;
...
//        view.setTranslationX(translationX);
    ...
    public interface OnWaterViewClick {
        void onWaterViewClick(WaterBean waterData, View view);
    }
}