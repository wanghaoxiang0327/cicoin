...
public class RxBus {
    ...
    private void callEvent(SubscriberMethod method, Object object) {
        ...
        List methods = this.subscriberMethodByEventType.get(eventClass);
    ...
    public void unregister(Object subscriber) {
        List subscribedTypes = this.eventTypesBySubscriber.get(subscriber);
    ...
    private void unSubscribeByEventType(Class eventType) {
        List disposables = this.subscriptionsByEventType.get(eventType);
        if (disposables != null) {
    ...
    private void unSubscribeMethodByEventType(Object subscriber, Class eventType) {
        List subscriberMethods = this.subscriberMethodByEventType.get(eventType);
        if (subscriberMethods != null) {
    ...
    public void send(int code) {
        this.bus.onNext(new Message(code, new BusData()));
    }


    public void sendPre(int code) {
        this.preBus.onNext(new Message(code, new BusData()));
    }
